namespace PivotExample.Test {
    ...
    public class MemoryDataReader : IDataReader {
        private readonly IEnumerator<DataRow> dataSource;

        public MemoryDataReader(IEnumerable<DataRow> dataSource) {
            this.dataSource = dataSource.GetEnumerator();
        }

        private DataRow Current { get { return dataSource.Current; }}
